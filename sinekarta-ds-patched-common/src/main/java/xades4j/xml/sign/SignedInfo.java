...
public class SignedInfo extends Manifest {
    ...
    public SignedInfo(
        ...
        c14nMethod = 
            XMLUtils.createElementInSignatureSpace(this._doc, Constants._TAG_CANONICALIZATIONMETHOD);
        ...
        if (hMACOutputLength > 0) {
            this.signatureAlgorithm = 
                new SignatureAlgorithm(this._doc, signatureMethodURI, hMACOutputLength);
        } else {
            this.signatureAlgorithm = new SignatureAlgorithm(this._doc, signatureMethodURI);
        }
    ...
    public SignedInfo(
        ...
        super(reparseSignedInfoElem(element, secureValidation), baseURI);
