...
//		Selector selector = new X509CertificateHolderSelector(rawTimeStampToken.getSID().getSubjectKeyIdentifier());
//		X509CertificateHolderSelector x509CertificateHolderSelector = new X509CertificateHolderSelector(rawTimeStampToken.getSID().getSubjectKeyIdentifier());
//	   	X509CertSelector certSelector = new JcaX509CertSelectorConverter().getCertSelector(x509CertificateHolderSelector); 
//	   	X509CertificateHolder certHolder = (X509CertificateHolder)certificateStore.getMatches(selector).iterator().next();
		
		X509CertificateHolder certHolder = (X509CertificateHolder)certificateStore.getMatches((Selector) rawTimeStampToken.getSID() ).iterator().next();
		try {
...
//					rawTimeStampToken.getCertificates().getMatches(rawTimeStampToken.getSID()).iterator().next();
			...
			//Selector selector = new X509CertificateHolderSelector(rawTimeStampToken.getSID().getSubjectKeyIdentifier());
			//X509CertificateHolder certHolder = (X509CertificateHolder) 
			//		rawTimeStampToken.getCertificates().getMatches(selector).iterator().next();
			
			X509CertificateHolder certHolder = (X509CertificateHolder) rawTimeStampToken.getCertificates().getMatches((Selector) rawTimeStampToken.getSID()).iterator().next();
